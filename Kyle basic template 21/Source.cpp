...
int main() {
	...
	const double priceOfcoffee = 4.99;
	int numberOfcoffee;
	double coffeeSubtotal;
	const double priceOfdoughnut = 1.99;
	int numberOfdoughnut;
	double doughnutSubtotal;
	double hst;
	double subtotal;
	...
	const int COL_QUANT = 4;
	const int COL_COST = 10;
	...
	cout << setw(2) << "----------------" << endl;
	cout << "" << endl;
	cout << left << setw(COL_NAME) << "Coffee" << "x " << setw(COL_QUANT - 1) << setprecision(0) << cinput << right << setw(COL_COST) << setprecision(2) << "$ "<<  coffeeSubtotal << endl;
	cout << left << setw(COL_NAME) << "Doughnuts" << "x " << setw(COL_QUANT - 1) << setprecision(0) << dinput << right << setw(COL_COST) << setprecision(2) << "$ " << doughnutSubtotal << endl;
	cout << "" << endl;
	cout << left << setw(COL_NAME) << "Subtotal" << setw(COL_QUANT - 1) << " " << right << setw(COL_COST + 2) << "$ " << coffeeSubtotal << endl;
	cout << "" << endl;
	cout << left << setw(COL_NAME) << "HST" << setw(COL_QUANT - 1) << "% 13" << right << setw(COL_COST + 2) << "$ " << hst << endl;
	cout << "" << endl;
	cout << "" << endl;
	cout << left << setw(COL_NAME) << "Total" << setw(COL_QUANT - 1) << " " << right << setw(COL_COST + 2) << "$ " << total << endl;
	cout << "" << endl;
